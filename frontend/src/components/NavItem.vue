...
const isActive = computed(() => {
  ...
  return route.path.startsWith(props.to) && props.to !== '/'
    ? true
    : props.exact
      ? route.path === props.to
      : route.path === props.to
...
// Icon mapping using inline SVG paths
const ICONS = {
  'chart-pie': 'M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z',
  'cash-register': 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h.01M12 11h.01M15 11h.01M4 19h16a2 2 0 002-2V7a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2z',
  ...
  'menu-alt': 'M4 6h16M4 12h8m-8 6h16',
  ...
  'office-pixel': 'M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V6a1 1 0 011-1h3a1 1 0 001-1V4z',
...
const iconComponent = {
  render() {
    const path = ICONS[props.icon] || ICONS['cog']
    return h('svg', {
